...
namespace PactNet
{
    public class PactVerifier : IPactVerifier
    {
        ...
        public PactVerifier(Action setUp, Action tearDown, PactVerifierConfig config = null)
            : this(setUp, tearDown, new FileSystem(), 
        ...
        public void Verify(string description = null, string providerState = null)
        {
            ...
            string loggerName = LogProvider.CurrentLogProvider.AddLogger(_config.LogDir, ProviderName.ToLowerSnakeCase(), "{0}_verifier.log");
        ...
        private static bool IsWebUri(string uri) => uri.StartsWith("http://", StringComparison.OrdinalIgnoreCase) 
