...
namespace PactNet.Tests
{
    public class PactVerifierTests
    {
        ...
        {
            string serviceProvider = "Event API";
            string serviceConsumer = "My client";
            string pactUri = "../../../Consumer.Tests/pacts/my_client-event_api.json";
            string pactFileJson = "{ \"provider\": { \"name\": \"Event API\" }, \"consumer\": { \"name\": \"My client\" }, \"interactions\": [{ \"description\": \"My Description\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description 2\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description\", \"provider_state\": \"My Provider State 2\" }], \"metadata\": { \"pactSpecificationVersion\": \"1.0.0\" } }";
        ...
        public void Verify_WithHttpPactFileUri_CallsHttpClientWithJsonGetRequest()
        {
            string serviceProvider = "Event API";
            string serviceConsumer = "My client";
            string pactUri = "http://yourpactserver.com/getlatestpactfile";
            string pactFileJson = "{ \"provider\": { \"name\": \"Event API\" }, \"consumer\": { \"name\": \"My client\" }, \"interactions\": [{ \"description\": \"My Description\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description 2\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description\", \"provider_state\": \"My Provider State 2\" }], \"metadata\": { \"pactSpecificationVersion\": \"1.0.0\" } }";
        ...
        public void Verify_WithHttpsPactFileUri_CallsHttpClientWithJsonGetRequest()
        {
            string serviceProvider = "Event API";
            string serviceConsumer = "My client";
            string pactUri = "https://yourpactserver.com/getlatestpactfile";
            string pactFileJson = "{ \"provider\": { \"name\": \"Event API\" }, \"consumer\": { \"name\": \"My client\" }, \"interactions\": [{ \"description\": \"My Description\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description 2\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description\", \"provider_state\": \"My Provider State 2\" }], \"metadata\": { \"pactSpecificationVersion\": \"1.0.0\" } }";
        ...
        public void Verify_WhenPactFileWithNoInteractionsExistOnFileSystem_CallsPactProviderValidator()
        {
            ...
            string serviceConsumer = "My client";
            string pactUri = "../../../Consumer.Tests/pacts/my_client-event_api.json";
            string pactFileJson = "{ \"provider\": { \"name\": \"" + serviceProvider + "\" }, \"consumer\": { \"name\": \"" + serviceConsumer + "\" }, \"metadata\": { \"pactSpecificationVersion\": \"1.0.0\" } }";
            var httpClient = new HttpClient();
        ...
        {
            string description = "Description that does not match an interaction";
            string pactUri = "../../../Consumer.Tests/pacts/my_client-event_api.json";
            string pactFileJson = "{ \"provider\": { \"name\": \"Event API\" }, \"consumer\": { \"name\": \"My client\" }, \"interactions\": [{ \"description\": \"My Description\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description 2\", \"provider_state\": \"My Provider State\" }, { \"description\": \"My Description\", \"provider_state\": \"My Provider State 2\" }], \"metadata\": { \"pactSpecificationVersion\": \"1.0.0\" } }";
            var httpClient = new HttpClient();
