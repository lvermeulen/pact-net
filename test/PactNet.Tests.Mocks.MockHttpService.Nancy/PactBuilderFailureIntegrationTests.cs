...
{
    public class PactBuilderFailureIntegrationTests : ICollectionFixture<FailureIntegrationTestsMyApiPact>
    {
        ...
        {
            string description = "A POST request to create a new thing";
        ...
        public void WhenRegisteringAnInteractionThatIsSentMultipleTimes_ThenPactFailureExceptionIsThrown()
        {
            ...
            {
                throw new Exception($"Wrong status code '{response1.StatusCode} and {response2.StatusCode}' was returned");
            }
